...
public class TestManyToOneAny2 extends BaseTest {
...
class PetOwner {
	...
	@Id
	private Long id;
	@Any(metaDef = "PropertyMetaDef2", metaColumn = @Column(name = "animal_type"))
	@AnyMetaDef(name = "PropertyMetaDef2", metaType = "string", idType = "long", metaValues = {
			@MetaValue(value = "cat", targetEntity = Cat.class), @MetaValue(value = "dog", targetEntity = Dog.class) })
