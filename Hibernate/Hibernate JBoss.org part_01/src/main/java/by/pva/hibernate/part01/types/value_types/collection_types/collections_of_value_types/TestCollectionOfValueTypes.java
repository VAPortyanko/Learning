...
public class TestCollectionOfValueTypes extends BaseTest {
	...
	public static void main(String[] args) {
		...
		doInJPA(entityManager -> {
			...
			person.getPhones().remove(0); // Delete all records with the current person id and re-insert remaining ones.
											...
											//
											// The @OrderColumn column works best when removing from the tail of the
											// collection,
											// as it only requires a single delete statement. Removing from the head or
											// the middle of the collection requires deleting the extra elements and
											// updating
