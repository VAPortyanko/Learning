...
public class TestFilterWithSQLFragmentAliasmapping {
	public static void main(String[] args) {
		...
		List<Account9> accounts = entityManager.createQuery("select a from Account9 a", Account9.class).getResultList();
...
class Account9 {
	...
	public String toString() {
		return "Account9 [id=" + id + ", amount=" + amount + ", rate=" + rate + ", active=" + active + ", deleted= "+ deleted + "]";
	}
}
