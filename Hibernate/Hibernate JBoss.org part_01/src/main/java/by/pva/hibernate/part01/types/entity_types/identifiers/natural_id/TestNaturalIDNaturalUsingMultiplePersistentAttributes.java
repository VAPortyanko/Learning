...
public class TestNaturalIDNaturalUsingMultiplePersistentAttributes extends BaseTest {
	...
	public static void main(String[] args) {
		...
		doInJPA(entityManager -> {
			...
			Book9 book2 = entityManager.unwrap(Session.class).byNaturalId(Book9.class)
					.using("productNumber", "973022823X").using("publisher", publisher).load();
