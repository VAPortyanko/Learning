...
public class TestImmutableCollection {
	...
	public static void main(String[] args) {
		...
		// batch2.getEvents().clear(); // The org.hibernate.HibernateException: changed an immutable collection instance: [by.pva.hibernate.part01.immutability.Batch.events#1]
		                               // will be thrown here.   
