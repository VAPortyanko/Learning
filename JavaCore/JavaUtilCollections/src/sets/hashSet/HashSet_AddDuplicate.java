...
public class HashSet_AddDuplicate {
	   ...
	   public static void main(String a[]){
		   ...
		   Entity e1 = new Entity(1, 2, 1);
		   Entity e2 = new Entity(1, 2, 2);
		   
		   System.out.println("We has created entity:" + e1);
		   System.out.println("We has created entity:" + e2);
		   ...
		   System.out.println("Content of HashSet: " + hs);
	   }
	}
...
class Entity{
	...
	public Entity(int a, int b, int id) {
		this.a = a;
		this.b = b;
		this.id = id;
