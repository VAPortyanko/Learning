package atomic.atomicIntegerArray;

import java.util.concurrent.atomic.AtomicIntegerArray;

public class AtomicIntegerArrayEx_Simple {
	   ...
	   public static void main(final String[] arguments) throws InterruptedException {
	      ...
	      Thread t1 = new Thread(new Increment(), "incrementer");
	      Thread t2 = new Thread(new Compare(), "comparator");
	      t1.start();
	      t2.start();
