...
// Map views (entrySet, keySet, values).
		...
		try {
			...
			System.out.println("Try to add element to keySet: " + e + "\n");
		}
		
		System.out.println("Removing element \"new A(1)\" from keySet: " + set + ":");
		set.remove(new A(1)); // If hashCode and equals method is defined, element will be deleted(New object but the same inner state).
		System.out.println("The keyset after deletion from keySet: " + set);
		System.out.println("The map after deletion from keySet: " + map);
...
System.out.println("\n***************************************************************************************\n");
System.out.println("Collections.emptyXXX, Collectioms.singeltonXXX - are also marked as \"immutable\".");
// ...
